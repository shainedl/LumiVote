const candidates = [
	...
	},
	{
		...
		'cover': 'NYC_image.jpg',
		'issues': [
			{ 'topic': 'Criminal Justice & Public Safety', 'statement': ' “A prosecutor’s first duty is to NOT PROSECUTE THE INNOCENT. That I regard it as important should have a deterrent effect. Delaying production of exculpatory evidence results in poor people being jailed while their lawyers await production of evidence. Jail pressures the innocent to plead guilty. The AG can change this.”'},		
			{ 'topic': 'Economy', 'statement': ' “NY\'s over-regulation of its people costs the people jobs, time, and money. I would scrutinize bad regulations, laws, & enforcement for unconstitutional flaws, and work to invalidate such laws."'},
			{ 'topic': 'Environment', 'statement': ' "There is ample evidence that Water Fluoridation causes brain injury and tumors. As Attorney General, I would first warn, then prosecute water companies that add Fluoride to the drinking water supply."'},	
			{ 'topic': 'Government Reform', 'statement': ' “I shall investigate & prosecute public officials (elected & otherwise) who divert this money to themselves or to their friends. My loyalty is to the people - - not to high officials of established political parties.”'},
			{ 'topic': 'Guns', 'statement': ' "The following NY State laws are unconstitutional: the Sullivan Law; Republican Gov. Pataki\'s Gun Ban; the NY Safe Act; & the NY Knife Ban Law (A switchblade is the safest knife a workman on a mast or a ladder can use.); all of which laws violate the 2nd Amendment."'},
		]
	},
	{
		'id': 'sussman',
